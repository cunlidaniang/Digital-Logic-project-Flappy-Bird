...
#
# Generated by export_simulation on Sat Jul 30 19:26:25 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './mem_pipe.sh' script.

./mem_pipe.sh -reset_run
...
./mem_pipe.sh -noclean_files

For more information on the script, please type './mem_pipe.sh -help'.
