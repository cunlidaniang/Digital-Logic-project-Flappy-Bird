...
#
# Generated by export_simulation on Sat Jul 30 16:50:08 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './mem_background.sh' script.

./mem_background.sh -reset_run
...
./mem_background.sh -noclean_files

For more information on the script, please type './mem_background.sh -help'.
