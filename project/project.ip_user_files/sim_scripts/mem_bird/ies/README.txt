...
#
# Generated by export_simulation on Sat Jul 30 18:44:40 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './mem_bird.sh' script.

./mem_bird.sh -reset_run
...
./mem_bird.sh -noclean_files

For more information on the script, please type './mem_bird.sh -help'.
